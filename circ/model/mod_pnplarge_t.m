function [tnet,term,param,def,symb]=mod_pnplarge_t(net)
%
% p1 : beta
% p2 : Is
% p3 : n
...
%                  2
%
%    iD = Is/alpha*(exp(vEB/(n*vT)) - 1)
%    iE = Is/alpha*exp(vEB/(n*vT))
%    alpha = beta/(beta+1)
...
tnet=nan*ones(3,24);
tnet(1,1:6)=[11 4 1 Is/alpha n vT];
tnet(2,1:6)=[ 6 3 4 1 2 alpha];
tnet(3,1:4)=[ 2 4 1 Is/alpha];
